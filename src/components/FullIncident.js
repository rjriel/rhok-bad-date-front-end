...
class FullIncident extends Component {
  ...
  render() {
    ...
    const { incidentType, incident_date, incident_description, car, offender } = this.props.fullIncident;
      ...
      <div >
        <Card>
          ...
          <CardText expandable>
            ...
            {offender &&
              [
                <div style={spaceEvenlyStyle}><span style={labelStyle}>Name:</span><span>{offender.name}</span></div>,
                <div style={spaceEvenlyStyle}><span style={labelStyle}>Age:</span><span>{offender.age}</span></div>,
                <div style={spaceEvenlyStyle}><span style={labelStyle}>Gender:</span><span>{offender.gender}</span></div>,
                <div style={spaceEvenlyStyle}><span style={labelStyle}>Height:</span><span>{offender.height}</span></div>,
                <div style={spaceEvenlyStyle}><span style={labelStyle}>Weight:</span><span>{offender.weight}</span></div>,
                <div style={spaceEvenlyStyle}><span style={labelStyle}>Skin Colour:</span><span>{offender.skin_colour}</span></div>,
                <div style={spaceEvenlyStyle}><span style={labelStyle}>Contact details:</span><span>{offender.contact_details}</span></div>,
              ]
            }
